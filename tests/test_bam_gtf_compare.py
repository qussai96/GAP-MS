...
class TestBamGtfCompare(unittest.TestCase):
    ...
    def test_compare_bam_support_to_input_gtf_writes_summary_and_no_overlap_stats(self, mock_run_gffcompare):
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # Updated outputs: single summary file and plot, plus overlap/no-overlap subsets
            ...
            self.assertTrue((compare_dir / "bam_supported_no_gtf_overlap.gtf").exists())
            self.assertTrue((compare_dir / "bam_supported_no_gtf_overlap.faa").exists())
            ...
            self.assertTrue((compare_dir / "bam_supported_no_gtf_overlap.tsv").exists())
            self.assertTrue((compare_dir / "bam_supported_no_gtf_overlap.gtf").exists())
            self.assertTrue((compare_dir / "bam_supported_no_gtf_overlap.faa").exists())
